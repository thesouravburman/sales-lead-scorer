...
st.markdown('''<div class="brand-watermark-left" style="pointer-events:auto;display:flex;gap:6px;align-items:center;">
  <a href="https://github.com/thesouravburman" target="_blank" title="GitHub"
     style="display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;
            border-radius:6px;background:rgba(16,185,129,0.12);border:1px solid rgba(16,185,129,0.4);
  ...
  <a href="https://www.linkedin.com/in/sourav-burman/" target="_blank" title="LinkedIn"
     style="display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;
            border-radius:6px;background:rgba(10,102,194,0.15);border:1px solid rgba(10,102,194,0.45);
  ...
  <a href="mailto:thesouravburman@gmail.com" title="thesouravburman@gmail.com"
     style="display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;
            border-radius:6px;background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.4);
