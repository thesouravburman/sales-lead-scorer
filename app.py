...
st.markdown("""
<div style="position:fixed;top:10px;right:18px;z-index:9999;
            display:flex;align-items:center;gap:8px;">
  <a href="mailto:thesouravburman@gmail.com"
     title="thesouravburman@gmail.com"
     style="display:inline-flex;align-items:center;justify-content:center;
            width:28px;height:28px;border-radius:6px;
            background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);
            color:#F59E0B;text-decoration:none;transition:background 0.2s;">
  ...
  <a href="https://www.linkedin.com/in/sourav-burman/" target="_blank"
     ...
     style="display:inline-flex;align-items:center;justify-content:center;
            ...
            color:#60A5FA;text-decoration:none;transition:background 0.2s;">
    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24"
         fill="currentColor">
  ...
  <a href="https://github.com/thesouravburman" target="_blank"
     ...
     style="display:inline-flex;align-items:center;justify-content:center;
            ...
            color:#10B981;text-decoration:none;transition:background 0.2s;">
    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24"
         fill="currentColor">
